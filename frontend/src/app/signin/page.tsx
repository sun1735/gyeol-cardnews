...
function SignInInner() {
  ...
  const anySocial = Boolean(providers.google || providers.kakao || providers.naver)
            ...
            <>
              {providers.google && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 border border-slate-200 rounded-[10px] px-4 py-3 bg-white hover:bg-slate-50 hover:border-slate-300 text-[14px] font-medium transition"
                >
              ...
              {providers.kakao && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 rounded-[10px] px-4 py-3 text-[14px] font-medium transition"
